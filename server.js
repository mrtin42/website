...
//     max: 1, // limit each IP to 1 requests per windowMs, you'd have to be mental (or a bot) (or a mental bot) to send more than 1 email per 12 hours
...
// temporary fix for vercel timeout issue
